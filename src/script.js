const tilesData = [
  { name: "Trending", searchTerm: `/movie/popular?api_key=${API_KEY}&language=en-US&page=1`, id: "popular" },
  { name: "Top Rated", searchTerm: `/movie/top_rated?api_key=${API_KEY}&language=en-US&page=1`, id: "top__rated" },
  { name: 'Action', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=28`, id: 'action'},
  { name: 'Adventure', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=12`, id: 'adventure'},
  { name: 'Animation', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=16`, id: 'animation'},
  { name: 'Comedy', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=35`, id: 'comedy'},
  { name: 'Crime', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=80`, id: 'crime'},
  { name: 'Documentary', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=99`, id: 'documentary'},
  { name: 'Drama', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=18`, id: 'Drama'},
  { name: 'Family', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=10751`, id: 'family'},
  { name: 'Fantasy', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=14`, id: 'fantasy'},
  { name: 'History', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=36`, id: 'history'},
  { name: 'Horror', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=27`, id: 'horror'},
  { name: 'Music', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=10402`, id: 'music'},
  { name: 'Mystery', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=9648`, id: 'mystery'},
  { name: 'Romance', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=10749`, id: 'romance'},
  { name: 'Science Fiction', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=878`, id: 'science__fiction'},
  { name: 'TV Movie', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=10770`, id: 'tv__movie'},
  { name: 'Thriller', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=53`, id: 'thriller'},
  { name: 'War', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=10752`, id: 'war'},
  { name: 'Western', searchTerm: `discover/movie?api_key=${API_KEY}&with_genres=37`, id: 'western'}
];
